...
describe('isBirthValid - unit tests', () => {
  ...
  it.concurrent('Should return invalid for "20290100"', () => {
    expect(isBirthValid('20290100')).toEqual({
      valid: false,
      reason: 'invalid',
    });
  });
  ...
  it.concurrent('Should return invalid for "2029/01/00"', () => {
    expect(isBirthValid('2029/01/00')).toEqual({
      valid: false,
      reason: 'invalid',
    });
  });
  ...
  it.concurrent('Should return invalid for "1992/13/12"', () => {
    expect(isBirthValid('1992/13/12')).toEqual({
      valid: false,
      reason: 'invalid',
    });
  });
  ...
  it.concurrent('Should return invalid for "abcd-ef-gh"', () => {
    expect(isBirthValid('abcd-ef-gh')).toEqual({
      valid: false,
      reason: 'invalid',
    });
  });
  ...
  it.concurrent('Should return invalid for "2000-02-30"', () => {
    expect(isBirthValid('2000-02-30')).toEqual({
      valid: false,
      reason: 'invalid',
    });
  });
  ...
  it.concurrent('Should return invalid for "1900-01-01"', () => {
    expect(isBirthValid('1900-01-01')).toEqual({
      valid: false,
      reason: 'invalid',
    });
  });
  ...
  it.concurrent('Should return invalid for "1800-05-20"', () => {
    expect(isBirthValid('1800-05-20')).toEqual({
      valid: false,
      reason: 'invalid',
    });
  });
  ...
  it.concurrent('Should return invalid for "0000-01-01"', () => {
    expect(isBirthValid('0000-01-01')).toEqual({
      valid: false,
      reason: 'invalid',
    });
  });
  ...
  it.concurrent(
    `Should return future for future date "${futureDateStr}"`,
    () => {
      expect(isBirthValid(futureDateStr)).toEqual({
        valid: false,
        reason: 'future',
      });
    },
